        ...
        <div class="container_Menu">
                    ...
                    <label for="" class="label_style" style="font-weight: 400; font-size:15px">
                        <?php
                            if(isset($_SESSION['userSession']['name'])){
                                echo $_SESSION['userSession']['name'];
            ...
            <section class="sectionMenu_container">
                <nav class="sectionMenu_nav">
                    ...
                    <label for="" class="sectionMenu_label-uno">Opciones:</label>
                    <a href="adminNoticias.html" class="sectionMenu_boton"><img class="sectionMenu_imgBoton" src="../imgs/newspaper_FILL0_wght400_GRAD0_opsz48.png" alt=""> Noticias</a>
                    <a href="adminGaleria.html" class="sectionMenu_boton"><img class="sectionMenu_imgBoton" src="../imgs/photo_library_FILL0_wght400_GRAD0_opsz48.png" alt=""> Galería</a>
                    <div class="sectionMenu_space-dos" style="width=100%; height=100px"></div>
